import { i as useCategories, t as Header } from "./Header-BVbnzp4q.js";
import { t as Footer } from "./Footer-CfwbBDT3.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/routes/kirana-essentials.tsx?tsr-split=component
function KiranaPage() {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: kiranaCats.map((c) => /* @__PURE__ */ jsxs(Link, {
						to: `/category/${c.slug}`,
