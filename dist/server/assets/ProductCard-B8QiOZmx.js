...
import { n as useAddToCart, r as useCart, u as useUpdateCartQty } from "./Header-HVVZP3-J.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Loader2, Minus, Plus } from "lucide-react";
//#region src/components/products/ProductCard.tsx
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs(Link, {
			...
			children: [
				...
				product.product_variants && product.product_variants.length > 0 && /* @__PURE__ */ jsx("div", {
					className: "mt-2 flex gap-2",
					children: product.product_variants.filter((v) => v.is_active !== false).map((v) => /* @__PURE__ */ jsx("button", {
						type: "button",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
						...
						children: add.isPending ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : "ADD"
					})]
				})
			]
		})]
