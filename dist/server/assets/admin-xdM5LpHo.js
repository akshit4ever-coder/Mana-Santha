...
import { a as useAuth, o as Button } from "./router-CCehujYb.js";
...
import { AlertTriangle, BarChart2, Bike, Boxes, ChevronRight, Eye, EyeOff, Image, LayoutDashboard, Loader2, Lock, Mail, Package, Settings, ShieldCheck, ShoppingBag, Tag, Ticket, Users } from "lucide-react";
//#region src/integrations/supabase/adminClient.ts
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-7 w-7" })
								}),
								/* @__PURE__ */ jsx("h1", {
						...
						/* @__PURE__ */ jsxs("form", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, {
									...
									children: [/* @__PURE__ */ jsx(Mail, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500" }), /* @__PURE__ */ jsx(Input, {
										id: "admin-email",
										type: "email",
								...
								/* @__PURE__ */ jsxs(Button, {
									...
									children: [loading ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(Lock, { className: "mr-2 h-4 w-4" }), "Sign in to Admin Panel"]
								})
							]
						}),
						/* @__PURE__ */ jsx("div", {
...
function AdminLayout() {
	...
	if (loading || adminLoading) return /* @__PURE__ */ jsx("div", {
		className: "flex min-h-screen items-center justify-center",
		children: /* @__PURE__ */ jsx(Loader2, { className: "h-8 w-8 animate-spin text-primary" })
	});
	if (!user && !adminUser) return /* @__PURE__ */ jsx(AdminLoginForm, {});
	if (!effectiveIsAdmin) return /* @__PURE__ */ jsxs("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-10 w-10 text-destructive" })
					}),
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(Header, {}), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("aside", { children: /* @__PURE__ */ jsxs("nav", {
				...
				children: [
					...
					NAV_ITEMS.map((n) => {
						...
						return /* @__PURE__ */ jsxs(Link, {
							...
							}), isActive && /* @__PURE__ */ jsx(ChevronRight, { className: "h-3.5 w-3.5 opacity-70" })]
						}, n.to);
					}),
					/* @__PURE__ */ jsx("div", {
