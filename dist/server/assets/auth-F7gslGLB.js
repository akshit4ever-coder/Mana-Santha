							...
							/* @__PURE__ */ jsx(TabsContent, {
								...
								children: /* @__PURE__ */ jsxs("form", {
									...
									children: [
										...
										showReset && /* @__PURE__ */ jsxs("div", {
											className: "mt-4 rounded-md border p-4 bg-background/50",
											children: [
												/* @__PURE__ */ jsx("div", {
													className: "text-sm text-muted-foreground mb-2",
													children: "Reset password using your registered phone number and full name."
												}),
												/* @__PURE__ */ jsx(Input, {
													id: "reset-phone",
													type: "tel",
												...
												/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx(Button, {
														...
														onClick: async () => {
															...
															try {
																const res = await (await import("./resetPasswordByPhone.functions-BbeWSA6t.js")).resetPasswordByPhone({ data: {
																	phone: resetPhone,
														...
														children: resetLoading ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : "Reset Password"
													}), /* @__PURE__ */ jsx(Button, {
														type: "button",
														variant: "ghost",
														onClick: () => {
