...
import { H as Clock, a as Truck, f as Tag, v as ShieldCheck } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-C15jIyMj.js
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: cats?.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "flex h-14 w-14 items-center justify-center rounded-full bg-gradient-fresh text-3xl",
								children: c.icon
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
