...
import { T as Package } from "../_libs/lucide-react.mjs";
import { a as useOrders, t as Header } from "./Header-CA9hksBN.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/orders-BPPrsGs7.js
					...
					children: orders.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [o.order_items?.slice(0, 4).map((it) => {
									const meta = resolveCartItemDisplayMeta({
										name: it.name,
								...
								}), o.order_items?.length > 4 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
