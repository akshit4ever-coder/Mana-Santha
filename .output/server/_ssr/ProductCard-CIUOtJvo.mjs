...
import { E as Minus, S as Plus, j as LoaderCircle } from "../_libs/lucide-react.mjs";
import { n as useAddToCart, r as useCart, u as useUpdateCartQty } from "./Header-CA9hksBN.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/ProductCard-CIUOtJvo.js
...
function ProductCard({ product }) {
	...
	const pct = discountPct(displayMrp, price);
	const outOfStock = (selectedVariant?.stock ?? product.stock) <= 0;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: [
				...
				product.product_variants?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: product.product_variants.map((variant) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: `rounded-full border px-2 py-1 text-[10px] font-medium ${selectedVariantId === variant.id ? "border-primary bg-primary text-primary-foreground" : "border-border bg-background text-muted-foreground"}`,
