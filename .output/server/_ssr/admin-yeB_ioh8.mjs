...
import { t as Header } from "./Header-D1MszUzt.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-yeB_ioh8.js
...
var adminStorage = typeof window !== "undefined" ? {
	getItem: (key) => localStorage.getItem(`supabase_admin_${key}`),
	setItem: (key, value) => localStorage.setItem(`supabase_admin_${key}`, value),
	removeItem: (key) => localStorage.removeItem(`supabase_admin_${key}`)
} : void 0;
var SUPABASE_URL = "https://jbdfcqycvmekkuaedtug.supabase.co";
var SUPABASE_PUBLISHABLE_KEY = "sb_publishable_4JlM59DH9ljI0yJiayfjDQ_Z2KRFhWl";
var adminSupabase = createClient(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
