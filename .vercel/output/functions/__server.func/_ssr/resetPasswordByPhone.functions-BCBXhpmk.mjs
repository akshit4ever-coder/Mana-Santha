...
//#region node_modules/.nitro/vite/services/ssr/assets/resetPasswordByPhone.functions-BCBXhpmk.js
...
var resetPasswordByPhone = createServerFn({ method: "POST" }).validator(objectType({
	...
	try {
		...
		const { supabaseAdmin } = await import("./client.server-D0HM5RRX.mjs");
