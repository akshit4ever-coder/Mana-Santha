...
import { i as Route$16 } from "./router-FeVGlH3n.mjs";
import { s as useProducts, t as Header } from "./Header-DXMouS3f.mjs";
import { t as Footer } from "./Footer-CfwbBDT3.mjs";
import { t as ProductCard } from "./ProductCard-B8vKsZx0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/search-CTlaG4_7.js
var import_jsx_runtime = require_jsx_runtime();
function SearchPage() {
	const { q } = Route$16.useSearch();
