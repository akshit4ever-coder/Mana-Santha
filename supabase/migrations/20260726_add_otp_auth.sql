...
GRANT INSERT, SELECT, UPDATE ON public.otp_requests TO authenticated;
GRANT ALL ON public.otp_requests TO service_role;
ALTER TABLE public.otp_requests ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Users see own OTP requests" ON public.otp_requests FOR SELECT TO authenticated USING (auth.uid() IS NOT NULL);
CREATE POLICY "Authenticated users insert OTP" ON public.otp_requests FOR INSERT TO authenticated WITH CHECK (auth.uid() IS NOT NULL);
