      ...
      <div className="container mx-auto grid gap-8 px-4 py-10 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-primary">Mana Santa</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>About Mana Santa</li><li>Careers</li><li>Terms</li><li>Privacy</li>
          </ul>
        </div>
      </div>
      <div className="border-t py-4 text-center text-xs text-muted-foreground">
        © {new Date().getFullYear()} Mana Santa. Fresh groceries, delivered daily.
      </div>
    </footer>
  );
}
